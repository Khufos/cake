...
class Post extends AbstractMigration
{
    ...
    public function change(): void
    {
        ...
        $table->addColumn('title', 'string', ['null' => false, 'limit' => 100]);
        $table->addColumn('slug', 'string', ['null' => false, 'limit' => 150]);
        $table->addColumn('user_id', 'integer', ['null' => false, 'signed' => false]); // Add 'signed' => false here
